      ...
      \begin{itemize}
        ...
        \item 
          \begin{figure}[H]
            ...
            \caption{Normalized PCA}
            \label{fig:normalized_pca}
          \end{figure}
        \item 
          \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\textwidth]{DRO.jpg}
            \caption{DRO}
            \label{fig:dro}
          \end{figure}
      \end{itemize}

    \item [2.] Choosing $d$ for the 1000D dataset:
      \begin{itemize}
        \item 
          \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\textwidth]{singular_values.jpg}
      ...
      \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{error_dro.jpg}
        \caption{Singular Values}
        \label{fig:singular_values}
      \end{figure}

      I also plot the DRO error rate for values of $d= {1...100}$, and we can again see a clear "knee point" at $d=30$.
      From the above two plots, we can conclude that the optimal value for $d$ is 30.

      \item [3.] Reconstruction errors for the two datasets.
      \begin{table}[H]
        \centering
        \begin{tabular}{|l|l|l|l|l|}
        \hline
        Dataset \slash Method & Buggy PCA & Demeaned PCA & Normalized PCA & DROP      \\ \hline
        2D             & 44.36     & 0.50         & 2.47           & 0.50      \\ \hline
        1000D (d = 31) & 136384.97 & 135697.80    & 136029.46      & 135697.80 \\ \hline
        \end{tabular}
